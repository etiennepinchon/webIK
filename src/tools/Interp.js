...
export class Interp {
	...
	/// T.
	/// InterpolationMode.
	static float(/*float*/t, /*InterpolationMode*/mode) {
		let interpT = 0;
	...
	// OK
	// Unity: (35.5, 20.1, 11.6)
	// Web: {x: 38.111999999999995, y: 20.833599999999997, z: 11.3888}

	/// Interpolate between two verctors by InterpolationMode mode
	static v3(/*Vector3*/v1, /*Vector3*/v2, /*float*/t, /*InterpolationMode*/mode) {
	...
	static lerpValue(/*float*/value, /*float*/target, /*float*/increaseSpeed, /*float*/decreaseSpeed) {
